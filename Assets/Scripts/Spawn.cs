...
public class Spawn : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < numOfEnemies; i++)
        {
            ...
            while (!validPosition)
            {
                pos = new Vector3(UnityEngine.Random.Range(gameObject.transform.position.x, SpawnerRight.transform.position.x),
                    UnityEngine.Random.Range(gameObject.transform.position.y, SpawnerRight.transform.position.y), 0);
            ...
            Vector2 direction = new Vector2(UnityEngine.Random.Range(gameObject.transform.position.x, SpawnerRight.transform.position.x),
                UnityEngine.Random.Range(gameObject.transform.position.x, SpawnerRight.transform.position.x));
